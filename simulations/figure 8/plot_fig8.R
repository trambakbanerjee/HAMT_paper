...
load("fig8_set5.RData")
out_exp1_others = out_exp1
load("fig8_set5_ash.RData")
out_exp1_ashes = out_exp1
load("fig8_set5_adapt.RData")
out_exp1_adapt = out_exp1
load("fig8_set5_camt_ihw.RData")
...
plotdata1<- as.data.frame(c(colMeans(out_exp1$fdr.camt,na.rm=TRUE),
                            ...
                            apply(out_exp1_ashes$fdr.npmleb,2,median)))
names(plotdata1)<-"fdr"
...
plotdata2<- as.data.frame(c(colMeans(out_exp1$etp.camt,na.rm=TRUE),
                            ...
                            apply(out_exp1_ashes$etp.npmleb,2,median)))
names(plotdata2)<-"etp"
