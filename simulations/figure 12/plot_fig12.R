...
# Figure 12 Setting 1 t likelihood

load("fig12_set1.RData")
out_exp1_others = out_exp1
load("fig12_set1_adapt.RData")
...
plotdata1<- as.data.frame(c(colMeans(out_exp1$fdr.adapt,na.rm=TRUE),
                            ...
                            apply(out_exp1_others$fdr.npmleb,2,median)))
names(plotdata1)<-"fdr"
...
plotdata2<- as.data.frame(c(colMeans(out_exp1$etp.adapt,na.rm=TRUE),
                            ...
                            apply(out_exp1_others$etp.npmleb,2,median)))
names(plotdata2)<-"etp"
